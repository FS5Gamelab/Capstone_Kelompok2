...
<div class="container-fluid py-3 flex-fill overflow-y-auto">
    ...
    <div class="row mb-3 mx-2 align-items-center py-1 border rounded">
        ...
        <div class="col-auto d-flex gap-2">
            <a href="{{ route('categories.show', $category->code) }}" class="btn p-1 btn-secondary d-flex">
                <span class="material-symbols-outlined">visibility</span>
            </a>
            <a href="{{ route('categories.edit', $category->code) }}" class="btn p-1 btn-primary d-flex">
